class MenuSupplierCtrl {
  constructor(context, $uibModalInstance, Chart, basicService,
              CommonCon, toolService, $scope, popupToolService, Table) {
    this.Chart = Chart;
    this.scope = $scope;
    this.Table = Table
    ...
    this.originField = angular.copy(this.localOrigin);
...
angular.module("hs.popups").controller("MenuSupplierCtrl", MenuSupplierCtrl);
