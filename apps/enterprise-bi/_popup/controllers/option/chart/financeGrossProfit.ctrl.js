class FinanceGrossProfitChartCtrl {
  constructor($uibModalInstance, Chart, basicService, CommonCon, toolService, $scope, context, popupToolService) {
    ...
    this.originField = angular.copy(this.Chart.financeAnalyze_grossProfitChart);
  }
...
angular.module("hs.popups").controller("financeGrossProfitChartCtrl", FinanceGrossProfitChartCtrl);
