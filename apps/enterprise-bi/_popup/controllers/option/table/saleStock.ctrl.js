class SaleStockTableCtrl {
  ...
  init() {
    ...
    // 供货分析页面 同比 配置
    this.options = this.context.haveOptions ? this.context.haveOptions : null;
...
angular.module("hs.popups").controller("saleStockTableCtrl", SaleStockTableCtrl);
