class FinanceGrossProfitTableCtrl {
  constructor($uibModalInstance, context, toolService, CommonCon, basicService,
    ...
    this.localOrigin = this.context.local
      ? this.context.local
      : CommonCon.local.TABLE_ORIGIN_FINANCE_GROSS_PROFIT;
...
angular.module("hs.popups").controller("financeGrossProfitTableCtrl", FinanceGrossProfitTableCtrl);
