class SaleProfitController {
  constructor(CommonCon, toolService, popups, popupDataService, Pop, Common,
    ...
    // 保存指标的local
    this.localTable = CommonCon.local.TABLE_ORIGIN_SALE_PROFIT;
    this.localChart = CommonCon.local.CHART_DATA_SALE_PROFIT;
  ...
  initialize(data) {
    ...
    this.key.pageId = `${this.commonCon.page.page_sale_income}_${this.job}`;

    this.local = {
      origin: `${this.commonCon.local.CHART_ORIGIN_SALE_PROFIT}_${this.job}`,
      data: `${this.commonCon.local.CHART_DATA_SALE_PROFIT}_${this.job}`
    };
  ...
  initField() {
    // 保存指标的local
    this.localTable = `${this.commonCon.local.TABLE_ORIGIN_SALE_PROFIT}_${this.job}`;
    this.localChart = `${this.commonCon.local.CHART_DATA_SALE_PROFIT}_${this.job}`;
...
angular.module("hs.saleStock").controller("saleProfitCtrl", SaleProfitController);
